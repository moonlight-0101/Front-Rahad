                        ...
                        <div>
                            {
                                hotel.slice(0, 5).map(item => (
                                    <div key={item.name} class="flex  items-center justify-between w-[100px] sm:w-[150px] mt-10">
                                        <label className="text-[12px]  sm:text-[16px] font-medium text-[#003666] dark:text-gray-300">{item.name} </label>
