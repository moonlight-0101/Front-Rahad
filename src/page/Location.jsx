    ...
    <div className="min-w-[360px] p-[1rem] sm:p-0 h-full  justify-center sm:justify-start flex-col sm:flex-row m-auto  sm:max-w-[1280px] flex ">
      ...
      <div className="sm:w-[940px]  h-full ">
        ...
        <div className="sm:mr-8 px-[6px] ">
          ...
          <div
            className={` ${
              deleteLocation ? "flex-col sm:flex-row" : ""
            } mb-10 flex justify-between  sm:mb-20} `}
          >
            <div>
              <h1 className="text-[#003666] mr-2 sm:mr-0 text-[20px] sm:text-[25px] -mt-10">
                 
                مکانهای مهم اطراف هتل 
              </h1>
            </div> 
            <div
              className={`flex relative ${
                deleteLocation && "mt-14 sm:mt-0"
              } items-center justify-center sm:justify-end sm:items-end gap-4`}
            >
              <button
                className={` flex border border-[#FB2047]  px-4 sm:px-4 py-2 -mt-10 rounded-md gap-2`}
                onClick={() => setDeleteLocation(!deleteLocation)}
              >
                <span>
                  <svg
                    width="24"
                ...
                <p
                  className={`${
                    deleteLocation ? "block px-3 sm:px-0" : "hidden"
                  } sm:block text-[#FB2047] text-[17px]`}
                >
                  {deleteLocation ? "حذف موارد انتخابی" : "حذف مکان"} 
                </p>
              </button>
              <button
                className={`flex border  ${deleteLocation ?"sm:hidden -top-14 absolute left-0":""} border-[#003666] px-2 sm:px-6 py-2 gap-2 -mt-10 rounded-md`}
              >
                <span>
                  <svg
                    width="26"
                  ...
                  >
                    <path
                      d="M23.8612 12.9999C23.8612 7.117 19.0479 2.30371 13.165 2.30371C7.28204 2.30371 2.46875 7.117 2.46875 12.9999C2.46875 18.8828 7.28204 23.6961 13.165 23.6961C19.0479 23.6961 23.8612 18.8828 23.8612 12.9999Z"
                      stroke="#003666"
                ...
                <p
                  className={`text-[#003666] text-[17px] hidden sm:block `}
                >   افزودن مکان جدید </p> 
               
              </button>
              <button
                className={`flex border ${deleteLocation ?"":"hidden"} border-[#003666] px-7  py-2 gap-2 -mt-10 rounded-md`}
              >لغو</button>
            </div>
          </div>
              ...
              <div className="flex items-center justify-center gap-10 mt-4 ">
                <div className="flex items-center justify-around">
                  <div className="flex items-center justify-center gap-4">
                    <label className="w-[104px] h-[52px] text-[#C2C7CC] text-[16px] flex items-center">
                      فرودگاه مهرآباد 
                    </label>
                  </div>
                ...
                <div className="w-[115px] border border-[#C2C7CC] h-[52px] -mr-6 flex items-center justify-center rounded-[10px] ">
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <span className="text-[#C2C7CC] text-[17px] ml-3">متر</span>
                  </div>
                </div>
                <div className="w-[115px] border border-[#C2C7CC] h-[52px] flex items-center justify-center rounded-[10px] ">
                  <div className="flex items-center justify-center gap-4">
                    <div>
                      <input
                        type="tel"
                        className="w-[60px]  outline-none text-xs"
                      />
                      <span className="text-[#C2C7CC] -mt-5  flex items-center justify-center ">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    <div className="-mt-4">
                      <input
                        ...
                        className="w-[60px] outline-none text-xs "
                      />
                      <span className="text-[#C2C7CC] -mt-2  flex items-center justify-center ">
                    ...
                    <span>
                      ...
                      >
                        <path
                          d="M17.9101 1H9.12131C6.00392 1 5.31534 2.55403 4.91472 4.45898L3.5 11.2391H23.5314L22.1167 4.45898C21.716 2.55403 21.0275 1 17.9101 1Z"
                          stroke="#C2C7CC"
                          stroke-width="1.5"
                          stroke-linecap="round"
                          stroke-linejoin="round"
