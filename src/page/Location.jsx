    ...
    <div className='min-w-[360px] p-[1rem] sm:p-0 h-full  justify-center sm:justify-start flex-col sm:flex-row m-auto  sm:max-w-[1280px] flex '>
      ...
      <div className="sm:w-[940px]  h-full ">
        ...
        <div className=" sm:mr-8">
          <div>
            <h1 className="text-[#003666] text-[25px] -mt-16">ویژگی و امکانات هتل</h1>
          </div>
          <div className=" flex  justify-around  items-center sm:justify-start  sm:gap-24 ">
            <div className="flex items-center justify-center gap-10 mr-10 mt-4">
              
                <div className="w-[115px] border border-[#087592] h-[52px] flex items-center justify-center rounded-[10px] ">
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <path d="M1 1L58 1" stroke="#C2C7CC" stroke-width="1.5" stroke-linecap="round" stroke-dasharray="3 3"/>
                        </svg>
                        </span>
                        </div>
                        <span className="text-[#003666] text-[17px]">
                            متر
                        </span>
                    </div>
                </div>
                ...
                <div className="w-[115px] border border-[#087592] h-[52px] flex items-center justify-center rounded-[10px] ">
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <path d="M17.9101 1H9.12131C6.00392 1 5.31534 2.55403 4.91472 4.45898L3.5 11.2391H23.5314L22.1167 4.45898C21.716 2.55403 21.0275 1 17.9101 1Z" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M26.0252 22.2929C26.1629 23.7592 24.986 25.025 23.4837 25.025H21.13C19.7779 25.025 19.5901 24.4485 19.3522 23.7342L19.1018 22.9822C18.7513 21.9546 18.5259 21.2653 16.7231 21.2653H10.313C8.51021 21.2653 8.2473 22.0423 7.93431 22.9822L7.68392 23.7342C7.44605 24.4485 7.25825 25.025 5.90614 25.025H3.55245C2.05009 25.025 0.873251 23.7592 1.01097 22.2929L1.71207 14.6606C1.88734 12.7808 2.25041 11.2393 5.53055 11.2393H21.5056C24.7857 11.2393 25.1488 12.7808 25.3241 14.6606L26.0252 22.2929Z" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M3.50196 7.47949H2.25" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M24.7832 7.47949H23.5312" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M13.5156 1.21289V3.71939" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M11.6406 3.71973H15.3965" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M6.00391 16.252H9.75979" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M17.2734 16.252H21.0293" stroke="#157B96" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </span>
                    </div>
                </div>
