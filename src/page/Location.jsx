            ...
            >
              ...
              <button
                className={`flex border  ${
                  deleteLocation ? "sm:hidden -top-14 absolute left-0" : ""
                } border-[#003666] px-2 sm:px-6 py-2 gap-2 -mt-10 rounded-md`}
              >
                <span>
                  <svg
                    width="26"
                ...
                <p className={`text-[#003666] text-[17px] hidden sm:block `}>
                  {" "}
                  افزودن مکان جدید{" "}
                </p>
              </button>
              <button
                className={`flex border ${
                  deleteLocation ? "" : "hidden"
                } border-[#003666] px-7  py-2 gap-2 -mt-10 rounded-md`}
              >
                لغو
              </button>
            </div>
