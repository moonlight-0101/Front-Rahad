...
  const handleMinuteChange = (event) => {
    ...
    return (
        ...
        <div>
        <input onChange={handleMinuteChange} placeholder='00' className='w-[92px] rounded-sm h-[57px] border border-black/10 mb-1 mt-4 flex items-center justify-center text-[34px] pr-6 outline-none focus:text-[#003666] hover:bg-[#F3F4F8]' value={value}/>
        <div className=' text-left ml-2 text-[#49454F] text-[12px]'>دقیقه</div>
        </div>
        <div className='w-[52px] -mt-2 rounded-sm h-[56px] border border-black/10 flex items-center justify-center text-[22px]'>{timeFormat}</div>
