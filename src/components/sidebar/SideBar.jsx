  ...
  return (
    <div className="flex   items-center  m-auto justify-center">
      <div className="flex   flex-col  bg-white fixed mt-14 sm:mt-0 px-[2rem]  sm:w-[230px] w-[63vh]  mr-2  items-center  h-full  sm:gap-4  sm:static  top-[70px] -right-[65px]">
          ...
          <div className="flex gap-3 sm:gap-8">
            <span>
              ...
              >
                ...
                />
                <path
                  d="M16.7302 2C17.3802 2 17.9602 2.02003 18.4802 2.09003C21.2502 2.40003 22.0002 3.70001 22.0002 7.26001V13.58C22.0002 17.14 21.2502 18.44 18.4802 18.75C17.9602 18.82 17.3902 18.84 16.7302 18.84H7.26022C6.61022 18.84 6.03022 18.82 5.51022 18.75C2.74022 18.44 1.99023 17.14 1.99023 13.58V7.26001C1.99023 3.70001 2.74022 2.40003 5.51022 2.09003C6.03022 2.02003 6.61022 2 7.26022 2H16.7302Z"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                ...
                />
                <path
                  d="M6.74023 14.11H6.76022H17.2702"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
        ...
        <div className="flex gap-11 sm:gap-8  items-center justify-around sm:justify-center w-full sm:w-[15vw]  px-2  group  h-[70px] transition-al duration-500 hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
          <div className="flex gap-3 sm:gap-8">
            <span>
              <svg
                width="24"
              ...
              >
                <path
                  ...
                  d="M19 10.5C21 10.5 22 9.5 22 7.5V5.5C22 3.5 21 2.5 19 2.5H17C15 2.5 14 3.5 14 5.5V7.5C14 9.5 15 10.5 17 10.5H19Z"
                  stroke="#157B96"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  className="group-hover:stroke-white"
                  d="M7 22.5C9 22.5 10 21.5 10 19.5V17.5C10 15.5 9 14.5 7 14.5H5C3 14.5 2 15.5 2 17.5V19.5C2 21.5 3 22.5 5 22.5H7Z"
                  stroke="#157B96"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  ...
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M6 10.5C3.79086 10.5 2 8.70914 2 6.5C2 4.29086 3.79086 2.5 6 2.5C8.20914 2.5 10 4.29086 10 6.5C10 8.70914 8.20914 10.5 6 10.5Z"
                  stroke="#157B96"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  ...
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M18 22.5C15.7909 22.5 14 20.7091 14 18.5C14 16.2909 15.7909 14.5 18 14.5C20.2091 14.5 22 16.2909 22 18.5C22 20.7091 20.2091 22.5 18 22.5Z"
                  stroke="#157B96"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <div className="flex gap-8 items-center justify-around sm:justify-center w-full sm:w-[15vw]  px-2  group  h-[70px] transition-al duration-500 hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
        ...
        <div className="flex gap-14 sm:gap-11 items-center justify-around sm:justify-center w-full sm:w-[15vw] px-2  group  h-[70px] transition-al duration-500 hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
        ...
        <div className="flex gap-5 items-center justify-around sm:justify-center w-full sm:w-[15vw]   px-2  group  h-[70px] transition-al duration-500 hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
          <div className="flex gap-3 sm:gap-6">
            <span>
              <svg
                width="24"
        ...
        <div className="flex gap-3  sm:-mr-8 items-center  sm:justify-center w-full sm:w-[15vw]   mr-[70px] pr-10 sm:pr-0  group  h-[70px] transition-al duration-500 hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
          <span>
            <svg
              width="24"
              height="24"
        ...
        <div className="flex gap-8 sm:-mr-20 items-center  sm:justify-center w-full sm:w-[15vw]   mr-[70px] pr-10 sm:pr-0  hover:mr-0   px-2  group  h-[70px] transition-all  hover:bg-gradient-to-r from-[#076E8A] to-[#2393B0] rounded-[10px]">
          <span>
            <svg
              width="24"
              height="24"
